        ...
        def add = {taxon ->
            results.taxa << [
                    ...
                    image: [title: taxon.preferredImage.title,
                            repoLocation: taxon.preferredImage.repoLocation,
                    ...
                    genera: taxon.genera.collect {[
                            ...
                            image: [title: it.preferredImage.title,
                                    repoLocation: it.preferredImage?.repoLocation,
    ...
    def speciesData = [
            Lamnidae: [
                    [name: 'Isurus oxyrinchus',
                     ...
                     CAABCode: '37 010001',
                     family: 'Lamnidae',
                     image: [repoLocation: 'http://bie.ala.org.au/repo/1111/174/1740514/raw.jpg',
                             license: 'Creative Common Attribution 3.0 Australia',
                             rights: 'Australian National Fish Collection, CSIRO, Image enhancement funded by CSIRO/FRDC',
                             creator: 'Australian National Fish Collection, CSIRO'],
                    ...
                    [name: 'Carcharodon carcharias',
                     ...
                     CAABCode: '37 010003',
                     family: 'Lamnidae',
                     image: [repoLocation: 'http://bie.ala.org.au/repo/1111/174/1740554/raw.jpg',
                             license: 'Creative Common Attribution 3.0 Australia',
                             rights: 'Australian National Fish Collection, CSIRO, Image enhancement funded by CSIRO/FRDC',
                             creator: 'Australian National Fish Collection, CSIRO'],
